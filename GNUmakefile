...
MENUCONFIG_COLOUR_SCHEME := MENUCONFIG_STYLE=aquatic
#MENUCONFIG_COLOUR_SCHEME := MENUCONFIG_STYLE=default
	
.PHONY: menuconfig
menuconfig:
		$(MENUCONFIG_COLOUR_SCHEME) python3 utils/Kconfiglib/menuconfig.py
